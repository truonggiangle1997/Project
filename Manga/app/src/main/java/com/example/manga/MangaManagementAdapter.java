...
public class MangaManagementAdapter extends RecyclerView.Adapter<MangaManagementAdapter.MangaViewHolder> {
    private List<Manga> mangaList;
    private Context mContext;
    public MangaManagementAdapter(List<Manga> mangalist, Context mcontext) {
    ...
    public MangaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.manga_management_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull final MangaViewHolder mangaViewHolder, final int position) {
        ...
        mangaViewHolder.btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                deleteManga(mangaViewHolder.id);
...
//                notifyDataSetChanged();
    ...
    public class MangaViewHolder extends RecyclerView.ViewHolder {
        ...
        public MangaViewHolder(View view){
            ...
            btnDelete = view.findViewById(R.id.btnMangaManagement_delete);
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(v.getContext(), EditMangaActivity.class);
    ...
    private void deleteManga(String mangaId){
        String url = "http://"+mContext.getString(R.string.ip_address)+"/doctruyenserver/manga/" + mangaId;
